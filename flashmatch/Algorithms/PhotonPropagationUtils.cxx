...
namespace flashmatch {
                      ...
                      const size_t k)
  {
    ...
    //std::cout<<"nbins_r: "<<nbins_r<<std::endl;
    std::vector<double> interp_vals(nbins_r, 0.);
    //Print interpolated values
    //std::cout<<"interp_vals: ";
    // for (size_t i = 0; i < interp_vals.size(); ++i) {
    //   std::cout << interp_vals[i] << " ";
    // }
    ...
    for (size_t i = 0; i < nbins_r; ++i) {
      ...
      // for (size_t j = 0; j < parameters[k][i].size(); ++j) {
      //   std::cout << parameters[k][i][j] << " ";
      // }
